  ...
  const galleryImages = [
    {
      ...
      descEn: 'Advanced drilling operations to collect geological samples from various depths',
    },
    {
      ...
      descEn: 'Using thermal imagery and satellite data to identify promising zones',
    },
    {
    ...
    },
    {
      ...
      descEn: 'Comprehensive site survey using advanced equipment and modern techniques',
    },
    {
      ...
      descEn: 'Complete site evaluation covering all aspects of geological assessment',
    },
  ];
      ...
      <section className="bg-primary text-white py-16">
        <div className="container max-w-6xl mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-4">
            {isArabic ? 'الدراسات الجيولوجية وتقييم المواقع' : 'Geological Studies & Site Evaluation'}
          </h1>
        ...
        <div className="container max-w-6xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-black text-primary">
              {isArabic ? 'معرض الدراسات الجيولوجية' : 'Geological Studies Gallery'}
            </h2>
          </div>
