...
const WhatsAppButton = () => {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 z-40 flex items-center gap-2 px-4 py-3 rounded-full bg-green-500 hover:bg-green-600 shadow-lg hover:shadow-xl transition-all duration-300 group ${
