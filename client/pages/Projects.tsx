  ...
  const projects = [
    {
      ...
      en: {
        ...
        description:
          "Integrated exploration programs and advanced geological studies, with development of an open-pit mine and ore supply to gold processing plants.",
        details: [
          "Advanced geological studies",
          "Open-pit mine development",
          "Modern extraction equipment",
          "Ore transportation to processing plants",
        ],
      },
      image:
    ...
    },
    {
      ...
      en: {
        ...
        description:
          "Extensive exploratory studies that resulted in identifying several sites with promising mining indicators, and opening new mines for extraction.",
        details: [
          "Extensive exploratory studies",
          "Identification of new mining sites",
          "Advanced extraction operations",
    ...
    },
    {
      ...
      en: {
        ...
        details: [
          ...
          "Workforce training",
          "Safety and environmental standards assurance",
        ],
      },
      image:
    ...
    },
    {
      ...
      en: {
        ...
        description:
          "Comprehensive rehabilitation of an international company's gold processing plant using CIL technology, including infrastructure updates, equipment upgrades, and administrative system development for optimal production.",
        details: [
    ...
    },
    {
      ...
      en: {
        ...
        description:
          "Comprehensive assessment and reactivation of an existing processing plant with improved operational efficiency and technological upgrades, ensuring sustainable production and output quality.",
        details: [
          "Comprehensive facility assessment",
          "Equipment and system updates",
          "Operational efficiency improvement",
          "Gradual and safe plant restart",
        ],
      },
      image:
    ...
    },
    {
      ...
      en: {
        ...
        location: "Northern State, Wadi Halfa",
        description:
          "Initial construction and development phase of an advanced VAT LEACH gold processing plant, including engineering design, construction, and commissioning to become a modern world-class facility.",
        details: [
          "Advanced engineering design",
          "Modern VAT LEACH technology",
          "Phased construction and development",
        ...
        <div className="container max-w-6xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-gray-200">
            {isArabic
              ...
              : "Leading projects in mining and geological exploration"}
          </p>
                ...
                {isArabic ? (
                  <>
                    <p className="text-slate-700 leading-relaxed text-lg">
                      المشاركة مع شركات أخرى في عمليات الاستكشاف في مربع للتعدين
                      تبلغ مساحته 344كم بالولاية الشماليه بمنطقة عكاشا و تم من
                      خلاله حفر ثمانيه مناجم من أصل اثني عشر منجم و سيتم تركيب
                      مصنع CIL قريبا.
                    </p>
                    <p className="text-slate-700 leading-relaxed text-lg">
                      مسح جيولوجي لمنطقة المحس بدأ من منطقة دلقو شمالاً إلى حدود
                      وادي حلفا جنوباً لتجهيز خرائط استثمارية للتعدين و أخذ أكثر
                      من 380 عينة مختلفة من الكوارتز و الحجر الجيري تراوحت النسب
                      من 1.5 إلى 6 جرام للطن الواحد.
                    </p>
                  </>
                ) : (
                  <>
                    <p className="text-slate-700 leading-relaxed text-lg">
                      Partnership with other companies in exploration operations
                      at a 344 km² mining concession in Northern State, in the
                      Akasha region. Eight mines have been drilled out of a
                      planned twelve, with a CIL plant installation scheduled
                      soon.
                    </p>
                    <p className="text-slate-700 leading-relaxed text-lg">
                      Geological survey of the Mahass region spanning from Delgo
                      in the north to Wadi Halfa in the south to prepare
                      investment maps for mining. Over 380 different samples of
                      quartz and limestone were collected with assay values
                      ranging from 1.5 to 6 grams per ton.
                    </p>
                  </>
                )}
              </div>
